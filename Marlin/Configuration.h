...
#define STRING_CONFIG_H_AUTHOR "(chubaka, Prometheus)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Prometheus"
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #define DEFAULT_bedKp 115.29
  #define DEFAULT_bedKi 22.47
  #define DEFAULT_bedKd 394.34
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -45, -5, -2.90 }
